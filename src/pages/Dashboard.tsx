...
import type { Anomaly, UploadResponse, CalculateResponse } from '../types/pnl';
...
export function Dashboard() {
  ...
  const handleCalculateSuccess = async (data: CalculateResponse) => {
    setLastCalculationRun(new Date().toLocaleString());
    const { anomaliesInserted, anomaliesUpdated } = data;
    showToast(
      `Calculation complete: ${anomaliesInserted} anomalies inserted, ${anomaliesUpdated} updated.`,
      'success'
    );
    await loadAnomalies();
  };
